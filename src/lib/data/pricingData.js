...
export const whatsappPackages = [
  { name: 'Básico',    messages: 30,  highlight: false, prices: { PE: 10, MX: 50 } },
  { name: 'Medio',     messages: 80,  highlight: false,  prices: { PE: 20, MX: 100 } },
  { name: 'Pro',       messages: 160, highlight: true, prices: { PE: 40, MX: 200 } },
  { name: 'Avanzado',  messages: 250, highlight: false, prices: { PE: 60, MX: 300 } },
  { name: 'Intensivo', messages: 500, highlight: false, prices: { PE: 100, MX: 500 } },
];
