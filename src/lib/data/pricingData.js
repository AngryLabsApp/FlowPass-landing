...
export const plans = [
  {
    ...
    prices: {
      ...
      anual: { PE: 100, MX: 500, US: 25 },
    },
    pricesWhatsapp: {
      mensual: { PE: 140, MX: 700, US: 40 },
      trimestral: { PE: 125, MX: 625, US: 35 },
      anual: { PE: 110, MX: 550, US: 30 },
    },
  ...
  },
  {
    ...
    pricesWhatsapp: {
      mensual: { PE: 220, MX: 1100, US: 65 },
      trimestral: { PE: 200, MX: 1000, US: 60 },
