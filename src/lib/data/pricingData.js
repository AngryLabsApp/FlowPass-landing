...
export const plans = [
  {
    ...
    prices: {
      ...
      trimestral: { PE: 160, MX: 800, US: 45 },
  ...
  },
  {
    ...
    registeredStudents: "Hasta 500 alumnos registrados",
    highlight: true,
    freeTrial: true,
    flowyBeta: true,
    prices: {
      mensual: { PE: 280, MX: 1400, US: 80 },
      trimestral: { PE: 250, MX: 1250, US: 70 },
      anual: { PE: 225, MX: 1120, US: 65 },
    },
    pricesWhatsapp: {
      mensual: { PE: 300, MX: 1600, US: 90 },
